...
<nav className="bg-yellow-200 border-gray-200 dark:bg-gray-900">
  ...
  <a href="https://flowbite.com/" className="flex items-center space-x-3 rtl:space-x-reverse">
      <img src="https://png.pngtree.com/png-vector/20220708/ourmid/pngtree-fast-food-logo-png-image_5763171.png" className="h-12" alt="FoodFiesta Logo" />
      <span className="self-center text-2xl font-semibold whitespace-nowrap dark:text-white">FoodFiesta</span>
  </a>
  <div className="flex md:order-2">
    ...
    <div className="items-center justify-between hidden w-full md:flex md:w-auto md:order-1" id="navbar-search">
      ...
      <ul className="flex flex-col p-4 md:p-0 mt-4 font-medium border border-gray-100 rounded-lg bg-gray-50 md:space-x-8 rtl:space-x-reverse md:flex-row md:mt-0 md:border-0 md:bg-yellow-200 dark:bg-gray-800 md:dark:bg-gray-900 dark:border-gray-700">
        <li>
